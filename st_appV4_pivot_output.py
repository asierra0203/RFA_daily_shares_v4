...
# --- Add download button for SQL query file ---
sql_query_path = os.path.join(SCRIPT_DIR, "RFA_model_query.sql")
try:
    ...
    st.info("SQL query file (RFA_model_query.sql) not found. Please upload it to the app directory.")
